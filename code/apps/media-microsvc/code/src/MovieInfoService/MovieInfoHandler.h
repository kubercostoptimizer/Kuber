...
void MovieInfoHandler::WriteMovieInfo(
  ...
  auto span = opentracing::Tracer::Global()->StartSpan("WriteMovieInfo");
  ...
  auto collection = mongoc_client_get_collection(mongodb_client, "movie-info", "movie-info");
...
void MovieInfoHandler::ReadMovieInfo(
  ...
  // TextMapWriter writer(writer_text_map);
  // auto parent_span = opentracing::Tracer::Global()->Extract(reader);
  auto span = opentracing::Tracer::Global()->StartSpan("ReadMovieInfo");
...
void MovieInfoHandler::UpdateRating(
  ...
  // TextMapWriter writer(writer_text_map);
  // auto parent_span = opentracing::Tracer::Global()->Extract(reader);
  auto span = opentracing::Tracer::Global()->StartSpan("UpdateRating");
