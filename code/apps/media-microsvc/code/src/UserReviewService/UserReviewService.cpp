...
int main(int argc, char *argv[]) {
  ...
  mongoc_client_pool_t *mongodb_client_pool = init_mongodb_client_pool(config_json, "user-review", 128);
  ClientPool<RedisClient> redis_client_pool("user-review-redis", redis_addr, redis_port, 0, 128, 1000);
  ClientPool<ThriftClient<ReviewStorageServiceClient>> review_storage_client_pool("review-storage-client", review_storage_addr, review_storage_port, 0, 128, 1000);
