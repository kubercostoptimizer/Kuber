...
void SocialGraphHandler::Follow(int64_t req_id, int64_t user_id, int64_t followee_id, const std::map<std::string, std::string> &carrier) {
...
void SocialGraphHandler::Unfollow(
  ...
  // Initialize a span
  std::map<std::string, std::string> writer_text_map;
  auto span = opentracing::Tracer::Global()->StartSpan("Unfollow");
...
void SocialGraphHandler::GetFollowers(std::vector<int64_t> &_return, const int64_t req_id, const int64_t user_id, const std::map<std::string, std::string> &carrier) {
  ...
  // Initialize a span
  std::map<std::string, std::string> writer_text_map;
  auto span = opentracing::Tracer::Global()->StartSpan("GetFollowers"); 
