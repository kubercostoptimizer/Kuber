...
local function _UploadUserId(req_id, post, carrier)
  ...
  local user_client = GenericObjectPool:connection(UserServiceClient, "user-service", 9090)
...
local function _UploadUniqueId(req_id, post, carrier)
  ...
  local unique_id_client = GenericObjectPool:connection(UniqueIdServiceClient, "unique-id-service", 9090)
...
local function _UploadMedia(req_id, post, carrier)
  ...
  local media_client = GenericObjectPool:connection(MediaServiceClient, "media-service", 9090)
  local status, err
