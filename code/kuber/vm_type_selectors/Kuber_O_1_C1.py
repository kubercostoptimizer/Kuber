...
class Kuber_O_1_C1:
        ...
        def WID_inputs_all_combinations(self,results_controller):
            logging.info('[Kuber_O_1_C1] finding WID inputs for cond 3')
            ...
            for combination in ssot.get_service_combinations():
                ...
                if combination not in results_cache.keys():
                   ...
                   self.results_controller.propagation_enabled = True
                   vm_types = self.results_controller.tobe_executed_vm_types(combination)
                   self.results_controller.propagation_enabled = False
                   if len(vm_types) != 0:
        ...
        def WID_inputs(self,current_combination,results_controller):
            logging.info('[Kuber_O_1_C1] finding WID inputs for cond 2')
            self.results_controller.add_trace = False
        ...
        def run(self, combination, results_controller_t):
             ...
             if len(vm_types) != 0:
                ...
                while len(vm_types) is not index:
                    ...
                    logging.info('[Kuber_O_1_C1] Cost of future solution: '+str(future_solution_price)+' current price '+str(current_best_price))
                    ...
                    if current_best_price > future_solution_price:
                        ...
                        logging.info('[Kuber_O_1_C1] Got result '+str(result))
                        ...
                        if result is None:
                            ...
                            if result:
                                ...
                                # logging.info('[Kuber_O_1_1] Cost of updated best future solution and current solution: '+str(best_future_solution_price)+' current price '+str(self.results_controller.current_best_deployment_price))  
                        ...
                        logging.warning('[Kuber_O_1_C1] skiping the experiment')
